...
class VistaDHT11:
    def __init__(self):
        ...
        self.label_temp = tk.Label(self.banner_temp, textvariable=self.estado_temp, font=("Arial", 12), fg="blue")
        self.label_temp.pack()
        self.banner_temp.pack(pady=5, fill="x")

        self.banner_hum = Frame(self.ventana, bg="lightgray", padx=10, pady=10)
        self.label_hum = tk.Label(self.banner_hum, textvariable=self.estado_hum, font=("Arial", 12), fg="purple")
        self.label_hum.pack()
